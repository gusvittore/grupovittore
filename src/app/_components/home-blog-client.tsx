...
export function HomeBlogClient({ articles }: { articles: BlogPostSummary[] }) {
  ...
  function updateActiveIndex() {
    ...
    if (maxScrollLeft - scroller.scrollLeft <= 2) {
  ...
  function scheduleActiveIndexUpdate() {
    if (scrollEndTimerRef.current) clearTimeout(scrollEndTimerRef.current);
    scrollEndTimerRef.current = setTimeout(updateActiveIndex, 120);
  }
