    ...
    >
      ...
      <div className="mx-auto grid min-h-[620px] w-full max-w-[1500px] items-center gap-12 px-5 py-20 sm:px-8 lg:grid-cols-[minmax(0,1.18fr)_minmax(410px,0.82fr)] lg:gap-20 lg:px-12 xl:px-16">
        <div className="max-w-[820px]">
          <h2 className="home-cta-title-mobile max-w-full font-serif text-[clamp(1.9rem,7.8vw,2.6rem)] font-medium leading-[1.04] tracking-[-0.025em] lg:hidden">
            <ControlledTitle
              lines={homeCtaTitleMobileLines}
              className="[&>span:not(:first-child)]:text-[#e1ac50]"
            />
          </h2>
